...
FEEDS = [
    ...
    (
        "HKEX News Releases",
        "https://www.hkexgroup.com/Global/RSS-Feed/NewsRelease?sc_lang=en",
        "Asia Markets & IPOs",
    ),
    (
        "Nasdaq Europe Main Markets",
...
IMPORTANT_KEYWORDS = terms(
    "raises|raised|funding|fundraise|fundraising|seed round|series a|"
    "series b|series c|venture capital|valuation|investment|invests|"
    "backed by|acquisition|acquires|acquired|merger|startup|"
    "artificial intelligence|generative ai|foundation model|"
    "large language model|ai model|developer platform|developer tools|"
    "open source|robotics|semiconductor|chipmaker|quantum computing|"
    "cloud infrastructure|data center|bitcoin|ethereum|crypto|"
    "cryptocurrency|blockchain|web3|stablecoin|tokenization|defi|"
    "layer 2|layer-2|mainnet|protocol|wallet|digital assets|"
    "institutional adoption|crypto regulation|crypto exchange|etf|"
    "stock market|stocks|shares|equities|public markets|public company|"
    "earnings|revenue|profit|guidance|listing|listed|new listing|"
    "market debut|ipo|initial public offering|ipo filing|files for ipo|"
    "secondary offering|stock exchange|nasdaq|nyse|hkex|"
    "london stock exchange|market rally|market selloff|interest rates|"
    "rate cut|rate hike|central bank|sec|regulation"
)

HIGH_PRIORITY_KEYWORDS = terms(
    "raises|raised|funding|acquisition|acquires|merger|valuation|"
    "initial public offering|ipo filing|files for ipo|market debut|"
    "public listing|earnings|guidance|rate cut|rate hike|stablecoin|"
    "institutional adoption|regulation|developer platform|open source|"
    "foundation model"
)

BLOCKED_KEYWORDS = terms(
    "keyboard|gaming mouse|headphones|earbuds|smartwatch|phone case|"
    "product review|buying guide|discount|coupon|deal of the day|"
    "best price|celebrity|movie review|tv show|trailer|"
    "video game review|gaming review|price prediction|could reach|"
    "next 100x|moonshot|presale|airdrop guide|buy now|sponsored|"
    "partner content|stock picks|stocks to buy|analyst picks"
)
